const Map<String, String> koKR = {
  ...
  "Password do not Match": "비밀번호가 틀렸습니다.",
  //deleteId dialog
  "ID": "아이디",
  ...
  "Pcs": "개",
  "Stock": "재고",
  "Warehousing reservation": "입고 예약",
  "Number of products:": "상품 수:",
  'Edit': '편집',
  //reg compl
  "Registration is complete!": "가입이 완료 되었습니다!",
  //sale manage
  "Day": "일",
  "Week": "주",
  "Month": "달",
  ...
  "Company name “Pick and Go”\nHas been changed to’***’":
      "상호명 ‘픽앤고’ 가\n‘***’ 로 변경 되었습니다",
  //company manage
  "Pick n Go Management": "픽앤고 관리",
  "Delete Business": "사업 삭제",
  "The company name “Pick and Go  ”\nAre you sure you want to delete?":
      '''상호명 ‘픽앤고’ 를\n삭제 하시겠습니까?''',
  "Business deletion complete": "사업 삭제 완료",
